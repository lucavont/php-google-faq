...
<style>
    ...
    <header>
        <div class="header-top">
            <div class='miologo'>
                <a href="#"><img src="img/logo.png" alt="Google"></a>
                <h3><a href="https://policies.google.com/">Privacy e termini</a></h3>
            </div>
            <div>
                <a href="#"><i class="fas fa-th"></i></a>
                <a href="#"><img class='propic' src="img/me.png" alt="you"></a>
            </div>
        </div>
    <div class="navbar">
        <ul>
    ...
    <main>
        <div class="wrapper">
            <?php foreach ($db as $el) { ?> 
            <h2 class='title'><?= $el["question"] ?></h2>
            <p><?= $el["answer"] ?></p>
            <?php } ?>
        </div>
    </main>
    ...
    <footer>
        ...
        <div class="lang">
            <img src="img/lang.png" alt="world">
